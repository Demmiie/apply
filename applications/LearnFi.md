...
Contact Name: [Founder Name - You can fill in]
...
LinkedIn: www.linkedin.com/in/omotosho-usman
      '''The linkedin and github were recently created so nothing is on '''
...
Feature X: Build MVP with wallet auth, smart contract-based learning sessions, NFT issuance after peer-led sessions

Feature Y: Create learner dashboard with crypto rewards tracker, NFT certificate viewer, and simple session scheduling
